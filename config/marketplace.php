...
return [
    ...
    /**
     * vender sale fee percent out of 100, must be from 0 to 95
     * When the product be sold, vender should pay fee for this product.
     */
    'vendor_coin_fee_percent' => env('VENDOR_COIN_FEE_PERCENT', 4),

    'vendor_usd_fee_percent' => env('VENDOR_USD_FEE_PERCENT', 3),

    /**
     * fee percent out of 100 when vender exchange usd to coin
     */
    'vender_exchange_fee_percent' => env('VENDOR_EXCHANGE_FEE_PERCENT', 2),

    /**
     * fee percent out of 100 when buyer exchange usd to coin
     */
    'buyer_exchange_fee_percent' => env('BUYER_EXCHANGE_FEE_PERCENT', 5),
