...
{{-- Disputes --}}
<div class="col-md-12 mt-5 py-2 w-full  shadow-md pt-4 pb-3 rounded-md bg-gray-800 text-gray-500 duration-200 transition-colors hover:text-gray-400" id="dispute">
    @if($purchase -> isDisputed())
        <h3 class="mb-1"><i class="fas fa-exclamation-triangle mr-2"></i>Dispute</h3>
        <hr>
