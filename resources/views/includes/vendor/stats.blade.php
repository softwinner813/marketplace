<!-- <div class="row mt-3">
    <div class="col text-center">
        <p><span>Member since:  <span class="font-weight-semibold">{{$vendor->memberSince()}}</span></span> |
            ...
            <span>Disputes within the last year: (<span class="text-success">won</span>/<span class="text-danger">lost</span>): <span class="text-success font-weight-semibold">{{$vendor->vendor->disputesLastYear(true)}}</span>/<span class="text-danger font-weight-semibold">{{$vendor->vendor->disputesLastYear(false)}}</span>  </span> |
