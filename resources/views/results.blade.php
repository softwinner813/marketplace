...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="row">
                <div class="col-6">
                    <h4 class="float-left"><i class="fa fa-search mr-2"></i>Search results for "{{$query}}" @if(request('user')) by user {{request('user')}} @endif</h4>
                </div>
                <div class="col-5">
            ...
            @if($products->count() == 0)
                <h4>
                    We could not find any results for that query, try to search for something else
                </h4>
            @else
